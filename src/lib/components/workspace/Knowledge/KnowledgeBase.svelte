<script lang='ts'>
  ...
  import { deleteFileById, updateFileDataContentById, uploadFile } from '$lib/apis/files'
  import {
  ...
  import { knowledge as _knowledge, config, mobile, showSidebar, user } from '$lib/stores'
