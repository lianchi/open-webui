<script lang='ts'>
  ...
  import { functions, knowledge as knowledgeCollections, models, tools, user } from '$lib/stores'
        ...
        <div class='self-center md:self-start flex justify-center my-2 shrink-0'>
          <div class='self-center'>
            ...
            >
              {#if info.meta.profile_image_url}
                <img
                  ...
                  alt='model profile'
                  class='rounded-xl size-72 md:size-40 object-cover shrink-0'
                />
              {:else}
                <img
            ...
            <div class='flex w-full mt-1 justify-end'>
              <button
                class='px-2 py-1 text-gray-500 rounded-lg text-xs hover:text-gray-700 dark:hover:text-gray-300'
                on:click={() => {
