...
export async function getModels(token: string = '',	connections: object | null = null,	base: boolean = false) {
  let error = null
...
export async function chatAction(token: string, action_id: string, body: ChatActionForm) {
  let error = null
...
export async function getToolServersData(i18n, servers: object[]) {
  return (
    await Promise.all(
      servers
...
export async function executeToolServer(token: string,	url: string,	name: string,	params: Record<string, any>,	serverData: { openapi: any, info: any, specs: any }) {
  let error = null
...
export async function generateTitle(token: string = '',	model: string,	messages: string[],	chat_id?: string) {
  let error = null
...
export async function generateTags(token: string = '',	model: string,	messages: string,	chat_id?: string) {
  let error = null
...
export async function generateEmoji(token: string = '',	model: string,	prompt: string,	chat_id?: string) {
  let error = null
...
export async function generateQueries(token: string = '',	model: string,	messages: object[],	prompt: string,	type?: string = 'web_search') {
  let error = null
...
export async function generateAutoCompletion(token: string = '',	model: string,	prompt: string,	messages?: object[],	type: string = 'search query') {
...
export async function generateMoACompletion(token: string = '',	model: string,	prompt: string,	responses: string[]) {
  const controller = new AbortController()
  let error = null
...
export async function getPipelinesList(token: string = '') {
  let error = null
...
export async function uploadPipeline(token: string, file: File, urlIdx: string) {
  let error = null
...
export async function downloadPipeline(token: string, url: string, urlIdx: string) {
  let error = null
...
export async function deletePipeline(token: string, id: string, urlIdx: string) {
  let error = null
...
export async function getPipelines(token: string, urlIdx?: string) {
  let error = null
...
export async function getPipelineValves(token: string, pipeline_id: string, urlIdx: string) {
  let error = null
...
export async function getPipelineValvesSpec(token: string, pipeline_id: string, urlIdx: string) {
  let error = null
...
export async function updatePipelineValves(token: string = '',	pipeline_id: string,	valves: object,	urlIdx: string) {
  let error = null
...
export async function updateModelFilterConfig(token: string,	enabled: boolean,	models: string[]) {
  let error = null
...
export async function updateModelConfig(token: string, config: GlobalModelConfig) {
  let error = null
